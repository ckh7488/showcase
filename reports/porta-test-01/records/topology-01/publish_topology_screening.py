...
current_comparison = {
    mode: winner_coarse['worst'][mode]['mVperV']/legacy['worst'][mode]['mVperV']
    for mode in ['differential', 'common', 'combined']
}
...
summary = {
    ...
    'winner':{
        ...
        'fineWorstDifferential_mVperV':winner['worst']['differential']['mVperV'] if selection_complete else None,
        'currentComparisonLevel':'coarse',
        'currentWorstDifferentialRatio':current_comparison['differential'],
        'currentWorstDifferentialChange_dB':20*np.log10(current_comparison['differential']),
        'currentWorstCommonRatio':current_comparison['common'],
        'currentWorstCombinedRatio':current_comparison['combined'],
    },
    'limits':[
